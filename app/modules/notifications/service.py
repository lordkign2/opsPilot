...
class NotificationService:
    ...
    async def create_notification(self, business_id: uuid.UUID, payload: NotificationCreate) -> Notification:
    ...
    async def get_notification(self, business_id: uuid.UUID, notification_id: uuid.UUID) -> Notification:
    ...
    async def mark_read(self, business_id: uuid.UUID, notification_id: uuid.UUID) -> Notification:
