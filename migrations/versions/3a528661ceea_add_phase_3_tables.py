...
def upgrade() -> None:
    ...
    sa.Column('subscription_plan', sa.Enum('FREE', 'STARTER', 'PROFESSIONAL', 'ENTERPRISE', name='subscription_plan', create_constraint=True), nullable=False),
    ...
    sa.Column('phone', sa.String(length=20), nullable=True),
    sa.Column('role', sa.Enum('OWNER', 'MANAGER', 'CASHIER', 'SALES_REP', name='user_role', create_constraint=True), nullable=False),
    ...
    sa.Column('status', sa.Enum('PENDING', 'PROCESSING', 'COMPLETED', 'CANCELLED', name='order_status', create_constraint=True), nullable=False),
    ...
    sa.Column('provider', sa.Enum('PAYSTACK', 'FLUTTERWAVE', name='payment_provider', create_constraint=True), nullable=False),
    sa.Column('tx_ref', sa.String(length=100), nullable=False),
    sa.Column('status', sa.Enum('PENDING', 'SUCCESS', 'FAILED', name='payment_status', create_constraint=True), nullable=False),
